function wsOnLoad(){    
    //declare variable i that is used for # of columsn 
    var i;
...
// Left to do 
// * Type of Exemption box not resetting to empty
// * find a way to preserve drop down select (Make hidden text box below selection, update that box so it saves in database and shows on snap)